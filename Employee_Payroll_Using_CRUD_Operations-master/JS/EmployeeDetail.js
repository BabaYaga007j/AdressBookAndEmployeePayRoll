...
const setForm = () => {
    ...
    setValue('#password',employeePayrollObject._password);
...
const setEmployeePayrollObject = () => {
    ...
    employeePayrollObject._password = getInputValueById('#password');
...
const setEmployeePayrollData = (employeePayrollData) => {
    ...
    employeePayrollData.password = employeePayrollObject._password;
    try {
